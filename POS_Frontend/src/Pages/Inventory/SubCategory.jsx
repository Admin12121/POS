...
import {useSubCategoryViewQuery} from  "../../Fetch_Api/Service/User_Auth_Api"

const SubCategory = ({user}) => {
    const [actualData, setActualData]  = useState(user.stor.code)
    const {data, isLoading } = useSubCategoryViewQuery(actualData);
    ...
    const table_data = data ? data.map(({id,subcategory,createdby,category,categorycode,description})=>({
      id:id,
      category: category,
        ...
        <form action="">
                ...
                <div className="flex-row">
                    ...
                    <div className="inputForm">
                        <input type="text" className="input" placeholder="Enter Category" required/>
                    </div>
                </div>
                <div className="flex-row">
                ...
                <div className="flex-row">
                    ...
                    <div className="inputForm">
                        <input type="text" className="input" placeholder="Enter CategorySlug" required/>
                    </div>
                </div>
                <div className="flex-row">
                    <label>Description</label>
                    <div className="inputForm" style={{height:"100px"}}>
                        <textarea type="text" style={{minHeight:"unset"}} className="input" placeholder="Enter CategorySlug" required/>
                    </div>
                </div>
                <div className="flex-row">
                    <label>Status</label>
